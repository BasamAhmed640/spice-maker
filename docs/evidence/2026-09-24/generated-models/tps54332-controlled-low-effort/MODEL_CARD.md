...
Model: `TPS54332DDA.lib` · subcircuit `TPS54332DDA` · sha256 `93d94658b5d4838f83457df14a8cc016fe9985f178a4dc7aa6c9eec0097ade06`
Spec `587a27b80d49586b` from DOC_af3d92b2c665_TPS54332_3_5_A_28_V_1_MHz_Step_Down_DC_D · authored via opencode_go in 2 turn(s)
...
| --- | --- | --- | --- | --- | --- | --- |
| `B001_REQ_024` | Adjustable output voltage down to 0.8 V. | min 0.8 | - | UNKNOWN | 0 |  |
| `B001_REQ_026` | Supports up to 3.5 A continuous output current. | max 3.5 | - | UNKNOWN | 0 |  |
| `B001_REQ_029` | Typical shutdown quiescent current: 1 μA. | typ 1e-06 / target 1e-06 | - | UNKNOWN | 0 |  |
| `B002_REQ_004` | Shutdown supply current is 1 μA typical, 4 μA max at EN = 0 V, VIN = 12 V, –40°C to 85°C. | typ 1e-06 / max 4e-06 / target 1e-06 | - | UNKNOWN | 5 |  |
| `B002_REQ_005` | Operating non-switching supply current is 82 μA typical, 120 μA max at VSENSE = 0.85 V. | typ 8.2e-05 / max 0.00012 / target 8.2e-05 | - | UNKNOWN | 5 |  |
| `B002_REQ_006` | Enable threshold (rising and falling) is 1.25 V min to 1.35 V max. | min 1.25 / max 1.35 | - | UNKNOWN | 5 |  |
| `B002_REQ_007` | EN input current at enable threshold – 50 mV is -1 μA typical. | typ -1e-06 / target -1e-06 | - | UNKNOWN | 5 |  |
| `B002_REQ_008` | EN input current at enable threshold + 50 mV is -4 μA typical. | typ -4e-06 / target -4e-06 | - | UNKNOWN | 5 |  |
| `B002_REQ_009` | Voltage reference is 0.772 V min, 0.8 V typ, 0.828 V max. | min 0.772 / typ 0.8 / max 0.828 / target 0.8 | - | UNKNOWN | 5 |  |
| `B002_REQ_013` | Error amplifier DC gain is 800 V/V typical at VSENSE = 0.8 V. (1) Specified by design. | typ 800 / target 800 | - | UNKNOWN | 5 |  |
| `B002_REQ_014` | Error amplifier unity gain bandwidth is 2.7 MHz typical with 5 pF capacitance from COMP to GND pins. (1) Specified by design. | typ 2.7e+06 / target 2.7e+06 | - | UNKNOWN | 5 |  |
| `B002_REQ_015` | Error amplifier source/sink current is ±7 μA typical at V(COMP) = 1.0 V, 100-mV overdrive. | typ 7e-06 / target 7e-06 | - | UNKNOWN | 5 |  |
| `B002_REQ_017` | Pulse-skipping Eco-mode switch current threshold is 160 mA typical. | typ 0.16 / target 0.16 | - | UNKNOWN | 5 |  |
| `B002_REQ_018` | Current limit threshold is 4.2 A min to 6.5 A max at VIN = 12 V. | min 4.2 / max 6.5 | - | UNKNOWN | 5 |  |
| `B002_REQ_020` | Slow-start (SS) pin charge current is 2 μA typical at V(SS) = 0.4 V. | typ 2e-06 / target 2e-06 | - | UNKNOWN | 5 |  |
| `B002_REQ_023` | Minimum controllable on time is 110 ns typical, 135 ns max at VIN = 12 V, 25°C. (1) Specified by design. | typ 1.1e-07 / max 1.35e-07 / target 1.1e-07 | - | UNKNOWN | 5 |  |
| `B002_REQ_026` | BOOT to PH pin UVLO threshold is 2.1 V typical; high-side MOSFET turns off when voltage falls below this. | typ 2.1 / target 2.1 | - | UNKNOWN | 8 |  |
| `B002_REQ_035` | Voltage reference initial accuracy is ±2%. | min -2 / max 2 | - | UNKNOWN | 9 |  |
| `B003_REQ-004` | TPS54332 minimum switch current limit is 4.2 A. | min 4.2 | - | UNKNOWN | 13 |  |
| `B003_REQ-005` | Enable threshold voltage is 1.25 V typical. | typ 1.25 / target 1.25 | - | UNKNOWN | 11 |  |
...
| `B003_REQ-017` | When VSENSE pin voltage goes above 109% × Vref, the high-side MOSFET is forced off. | min 0.872 | - | UNKNOWN | 11 |  |
| `B003_REQ-018` | When VSENSE pin voltage falls below 107% × Vref, the high-side MOSFET is enabled again. | max 0.856 | - | UNKNOWN | 11 |  |
| `B004_REQ_TPS54332DDA_VREF_0P8V` | Internal reference voltage VREF is 0.8 V (typical). | typ 0.8 / target 0.8 | - | UNKNOWN | 17 |  |
| `B004_REQ_TPS54332DDA_VGGM_800` | VGGM is 800 (error amplifier voltage gain). | typ 800 / target 800 | - | UNKNOWN | 17 |  |
| `B005_REQ-MAX-DUTY-CYCLE` | The upper output voltage set point limit is constrained by the maximum duty cycle of 91%. | max 91 | - | UNKNOWN | 19 |  |
| `B005_REQ-MIN-ON-TIME` | The lower output voltage limit is constrained by the minimum controllable on time, which can be as high as 130 ns. | max 1.3e-07 | - | UNKNOWN | 20 |  |
