...
Model: `LM358.lib` · subcircuit `LM358` · sha256 `da0a66609466b92faf4bd338bb14f91905db5b3d53e90a3af8b0b0fde56426e3`
Spec `0fb03ad8fd52101e` from DOC_58c89c68aff6_lm358_datasheet · authored via opencode_go in 2 turn(s)
...
| --- | --- | --- | --- | --- | --- | --- |
| `LM358_VOS_CH1` | Input offset voltage magnitude at VS=5 V, VCM near 0 V, VO=1.4 V; amplifier 1 | max 0.007 | opamp_value=0.003014 | PASS | 9 | LM358_VOS_CH1 [DOCUMENTED_LIMIT]: measured opamp_value=0.003014 V within <= 0.007 V |
...
| `LM358_IOS_CH1` | Input offset current magnitude at VS=5 V, VO=1.4 V; amplifier 1 | max 5e-08 | opamp_value=2.00301e-09 | PASS | 9 | LM358_IOS_CH1 [DOCUMENTED_LIMIT]: measured opamp_value=2.00301e-09 A within <= 5e-08 A |
| `LM358_AOL_CH1` | Open-loop gain at VS=15 V, VO=6 V, RL=2 kohm; one point in the specified output range; amplifier 1 | min 25000 | opamp_value=98978.6 | PASS | 9 | LM358_AOL_CH1 [DOCUMENTED_LIMIT]: measured opamp_value=98978.6 V/V within >= 25000 V/V |
| `LM358_GBW_CH1` | Typical gain bandwidth product at VS=5 V; amplifier 1 | typ 700000 / target 700000 | opamp_value=701123 | PASS | 9 | LM358_GBW_CH1 [TYPICAL_VALUE]: measured opamp_value=701123 Hz, \|measured - typ 700000\| = 1123.07 Hz versus the 10 % band 70000 Hz (typical-value comparison, not a min/max limit check) |
| `LM358_SR_RISE_CH1` | Typical unity-gain slew rate, rise, 1 V to 3 V step at VS=5 V; amplifier 1 | typ 300000 / target 300000 | opamp_value=299471 | PASS | 9 | LM358_SR_RISE_CH1 [TYPICAL_VALUE]: measured opamp_value=299471 V/s, \|measured - typ 300000\| = 528.775 V/s versus the 10 % band 30000 V/s (typical-value comparison, not a min/max limit check) |
| `LM358_SR_FALL_CH1` | Typical unity-gain slew rate, fall, 1 V to 3 V step at VS=5 V; amplifier 1 | typ 300000 / target 300000 | opamp_value=299647 | PASS | 9 | LM358_SR_FALL_CH1 [TYPICAL_VALUE]: measured opamp_value=299647 V/s, \|measured - typ 300000\| = 352.549 V/s versus the 10 % band 30000 V/s (typical-value comparison, not a min/max limit check) |
...
| `LM358_VOS_TYP_CH1` | Typical offset magnitude; amplifier 1 | typ 0.003 / target 0.003 | opamp_value=0.003014 | PASS | 9 | LM358_VOS_TYP_CH1 [TYPICAL_VALUE]: measured opamp_value=0.003014 V, \|measured - typ 0.003\| = 1.39978e-05 V versus the 10 % band 0.0003 V (typical-value comparison, not a min/max limit check) |
| `LM358_IB_TYP_CH1` | Typical input bias current magnitude (current flows out of the input pins); amplifier 1 | typ 2e-08 / target 2e-08 | opamp_value=2.00015e-08 | PASS | 9 | LM358_IB_TYP_CH1 [TYPICAL_VALUE]: measured opamp_value=2.00015e-08 A, \|measured - typ 2e-08\| = 1.507e-12 A versus the 10 % band 2e-09 A (typical-value comparison, not a min/max limit check) |
| `LM358_IOS_TYP_CH1` | Typical input offset current magnitude; amplifier 1 | typ 2e-09 / target 2e-09 | opamp_value=2.00301e-09 | PASS | 9 | LM358_IOS_TYP_CH1 [TYPICAL_VALUE]: measured opamp_value=2.00301e-09 A, \|measured - typ 2e-09\| = 3.014e-12 A versus the 10 % band 2e-10 A (typical-value comparison, not a min/max limit check) |
| `LM358_AOL_TYP_CH1` | Typical open-loop gain at VS=15 V, VO=6 V, RL=2 kohm; amplifier 1 | typ 100000 / target 100000 | opamp_value=98978.6 | PASS | 9 | LM358_AOL_TYP_CH1 [TYPICAL_VALUE]: measured opamp_value=98978.6 V/V, \|measured - typ 100000\| = 1021.36 V/V versus the 10 % band 10000 V/V (typical-value comparison, not a min/max limit check) |
...
| `LM358_VOS_CH2` | Input offset voltage magnitude at VS=5 V, VCM near 0 V, VO=1.4 V; amplifier 2 | max 0.007 | opamp_value=0.003014 | PASS | 9 | LM358_VOS_CH2 [DOCUMENTED_LIMIT]: measured opamp_value=0.003014 V within <= 0.007 V |
...
| `LM358_IOS_CH2` | Input offset current magnitude at VS=5 V, VO=1.4 V; amplifier 2 | max 5e-08 | opamp_value=2.00301e-09 | PASS | 9 | LM358_IOS_CH2 [DOCUMENTED_LIMIT]: measured opamp_value=2.00301e-09 A within <= 5e-08 A |
| `LM358_AOL_CH2` | Open-loop gain at VS=15 V, VO=6 V, RL=2 kohm; one point in the specified output range; amplifier 2 | min 25000 | opamp_value=98978.6 | PASS | 9 | LM358_AOL_CH2 [DOCUMENTED_LIMIT]: measured opamp_value=98978.6 V/V within >= 25000 V/V |
| `LM358_GBW_CH2` | Typical gain bandwidth product at VS=5 V; amplifier 2 | typ 700000 / target 700000 | opamp_value=701123 | PASS | 9 | LM358_GBW_CH2 [TYPICAL_VALUE]: measured opamp_value=701123 Hz, \|measured - typ 700000\| = 1123.07 Hz versus the 10 % band 70000 Hz (typical-value comparison, not a min/max limit check) |
| `LM358_SR_RISE_CH2` | Typical unity-gain slew rate, rise, 1 V to 3 V step at VS=5 V; amplifier 2 | typ 300000 / target 300000 | opamp_value=299471 | PASS | 9 | LM358_SR_RISE_CH2 [TYPICAL_VALUE]: measured opamp_value=299471 V/s, \|measured - typ 300000\| = 528.775 V/s versus the 10 % band 30000 V/s (typical-value comparison, not a min/max limit check) |
| `LM358_SR_FALL_CH2` | Typical unity-gain slew rate, fall, 1 V to 3 V step at VS=5 V; amplifier 2 | typ 300000 / target 300000 | opamp_value=299647 | PASS | 9 | LM358_SR_FALL_CH2 [TYPICAL_VALUE]: measured opamp_value=299647 V/s, \|measured - typ 300000\| = 352.549 V/s versus the 10 % band 30000 V/s (typical-value comparison, not a min/max limit check) |
...
| `LM358_VOS_TYP_CH2` | Typical offset magnitude; amplifier 2 | typ 0.003 / target 0.003 | opamp_value=0.003014 | PASS | 9 | LM358_VOS_TYP_CH2 [TYPICAL_VALUE]: measured opamp_value=0.003014 V, \|measured - typ 0.003\| = 1.39978e-05 V versus the 10 % band 0.0003 V (typical-value comparison, not a min/max limit check) |
| `LM358_IB_TYP_CH2` | Typical input bias current magnitude (current flows out of the input pins); amplifier 2 | typ 2e-08 / target 2e-08 | opamp_value=2.00015e-08 | PASS | 9 | LM358_IB_TYP_CH2 [TYPICAL_VALUE]: measured opamp_value=2.00015e-08 A, \|measured - typ 2e-08\| = 1.507e-12 A versus the 10 % band 2e-09 A (typical-value comparison, not a min/max limit check) |
| `LM358_IOS_TYP_CH2` | Typical input offset current magnitude; amplifier 2 | typ 2e-09 / target 2e-09 | opamp_value=2.00301e-09 | PASS | 9 | LM358_IOS_TYP_CH2 [TYPICAL_VALUE]: measured opamp_value=2.00301e-09 A, \|measured - typ 2e-09\| = 3.014e-12 A versus the 10 % band 2e-10 A (typical-value comparison, not a min/max limit check) |
| `LM358_AOL_TYP_CH2` | Typical open-loop gain at VS=15 V, VO=6 V, RL=2 kohm; amplifier 2 | typ 100000 / target 100000 | opamp_value=98978.6 | PASS | 9 | LM358_AOL_TYP_CH2 [TYPICAL_VALUE]: measured opamp_value=98978.6 V/V, \|measured - typ 100000\| = 1021.36 V/V versus the 10 % band 10000 V/V (typical-value comparison, not a min/max limit check) |
...
| `LM358_IQ_TYP` | Typical no-load supply current per amplifier at VS=5 V, VO=2.5 V | typ 0.00035 / target 0.00035 | opamp_value=0.00035 | PASS | 9 | LM358_IQ_TYP [TYPICAL_VALUE]: measured opamp_value=0.00035 A, \|measured - typ 0.00035\| = 2.51037e-12 A versus the 10 % band 3.5e-05 A (typical-value comparison, not a min/max limit check) |
...
## Supporting material (searched, not evidence for the verdicts)

The search did not produce usable sources this run (`skipped`: disabled: internet reinforcement was not enabled for this build).

This affects nothing above: the rows were judged by simulation against the datasheet as usual.
